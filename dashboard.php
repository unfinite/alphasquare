...
-> Slingshot was added! <br>
-> Redesign of the Action Bar, now it is 100% responsive and hopefully... SEXY! comment on the design, on the official debate, &Slingshot.
...
<div class="fw">
<article class="box postc">
Hello there! Seems like you're new here. Let's get started; click the Alphasquare logo up there to open Slingshot.
Then, click the people icon to follow some people! 
</article></div>
...
<div id="popover_content_wrapper" style="display: none">
  <div><center><img class="img-circle" style="width:100px;height:100px;" src="<?php profilePictureID($_SESSION['userid']) ?>" ><br><hr>
         <a href="dashboard" class="action-bar"><span class="glyphicon glyphicon-globe animated bounceIn"></span></a>&nbsp;

   <a class="action-bar" ><span class="glyphicon glyphicon-user animated bounceIn"></span></a>&nbsp;

    <a href="find" class="action-bar"><span class="glyphicon glyphicon-search  animated bounceIn"></span></a>&nbsp;


<a href="settings" class="action-bar"><span class="glyphicon glyphicon-cog  animated bounceIn"></span></a>&nbsp;
</center>
</div>
</div>
<script>
$('#slingshot').popover({ placement: 'bottom', html:true, container: 'body', content: function() {
      return $('#popover_content_wrapper').html();} })  .click(function(e) {
        e.preventDefault();
     });
